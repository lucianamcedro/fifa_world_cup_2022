...
class StickersRepositoryImpl implements StickersRepository {
  ...
  Future<StickerModel?> findStickerByCode(
    ...
    try {
      ...
      log('Erro ao buscar firurinha', error: e, stackTrace: s);
  ...
  Future<StickerModel> create(RegisterStickerModel registerStickerModel) async {
    try {
      ...
      throw RepositoryException(
          message: 'Erro aoi registrar figurinha no album');
    }
  }
  ...
  Future<void> registerUserSticker(int stickerId, int amount) async {
    try {
      ...
      log('Erro ao inserir figurinha no seu album', error: e, stackTrace: s);
      throw RepositoryException(
          message: 'Erro ao inserir figurinha no seu album');
    }
  }
